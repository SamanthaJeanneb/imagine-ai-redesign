      ...
      <aside className="flex w-56 shrink-0 flex-col border-r border-imagine-border bg-imagine-surface-raised p-m">
        ...
        <nav aria-label="File libraries" className="flex flex-col gap-xxs">
          <motion.button
            ...
            className={cn(
              "flex h-9 items-center gap-s border-l-2 border-transparent px-s text-left transition-colors outline-none hover:bg-imagine-surface focus-visible:ring-2 focus-visible:ring-ring/40",
              sectionId === "all" &&
                "border-imagine-secondary bg-imagine-surface font-medium",
            )}
          >
          ...
          {sections.map((section) => {
            ...
            return (
              <motion.button
                ...
                className={cn(
                  "flex h-10 items-center gap-s border-l-2 border-transparent px-s text-left transition-colors outline-none hover:bg-imagine-surface focus-visible:ring-2 focus-visible:ring-ring/40",
                  active &&
                    "border-imagine-secondary bg-imagine-surface font-medium",
                )}
              >
          ...
          <section className="min-h-0 overflow-y-auto border-r border-imagine-border">
            <AnimatePresence initial={false} mode="wait">
              {view === "files" ? (
                    ...
                    <div className="flex flex-col gap-s">
                      ...
                      <div className="divide-y divide-imagine-border border-y border-imagine-border">
                        {files.map((file) => {
                          ...
                          const owner =
                            currentSection?.title ?? ownerByFileId.get(file.id);
                          return (
                            <motion.button
                              key={file.id}
                              type="button"
                            ...
                            >
                              <Icon
                                name="file-lines"
                                size="s"
                                className="ml-xs text-imagine-foreground-muted"
                              />
                ...
                >
                  <header>
                    <h2 className="type-heading font-semibold">Agent skills</h2>
